"""
Django settings for TRAVIS_JEPSON_EXAM_OPTION_G project.
...
ROOT_URLCONF = 'TRAVIS_JEPSON_EXAM_OPTION_G.urls'
...
WSGI_APPLICATION = 'TRAVIS_JEPSON_EXAM_OPTION_G.wsgi.application'
